...
function generateObstacles() {
 // ANya write code here- 2 type of obstacles " mushroom and turtle"
 if(frameCount % 200 === 0){
   var mushroom = createSprite(1200, 120, 40, 10);
   mushroom.addAnimation("mushroom", mushObstacleImage);
   mushroom.y = 550;
   mushroom.scale = 0.2;
   mushroom.velocityX = -5;
   mushroom.lifetime = 1200;
   obstaclesGroup.add(mushroom);
 }

 if(frameCount % 301 === 0){
  var turtle = createSprite(1200, 120, 40, 10);
  turtle.addAnimation("turtle", turtleObstacleImage);
  turtle.y = 550;
  turtle.scale = 0.2;
  turtle.velocityX = -5;
  turtle.lifetime = 1200;
